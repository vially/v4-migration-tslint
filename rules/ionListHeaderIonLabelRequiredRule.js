...
exports.ruleName = 'ion-list-header-ion-label-required';
const TemplateVisitor = ionLabelRequired_1.createIonLabelRequiredTemplateVisitorClass('ion-list-header');
